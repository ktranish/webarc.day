      ...
      <article className="prose prose-lg">
        <div>
          ...
          <section aria-labelledby="data-security-heading">
            ...
            <p className="text-gray-600">
              We use MongoDB for data storage and authentication. Your data is
              stored securely and encrypted in transit and at rest. We implement
          ...
          <section aria-labelledby="third-party-heading">
            ...
            <ul
              ...
              className="list-disc text-gray-600"
            >
              <li>MongoDB for database and authentication</li>
