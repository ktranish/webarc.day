...
function Header() {
  return (
    <header className="flex flex-col gap-y-4">
      ...
      <a
        href="https://github.com/ktranish/webarc.day/issues/new"
        target="_blank"
        rel="noopener noreferrer nofollow"
        className="mx-auto inline-flex w-fit items-center gap-x-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:border-gray-300 hover:bg-gray-50 focus:ring-2 focus:ring-blue-100 focus:outline-none"
      >
        <svg
          className="h-4 w-4"
          fill="currentColor"
